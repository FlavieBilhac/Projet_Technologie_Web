...
@WebServlet(name = "salesByProduct", urlPatterns = {"/salesByProduct"}) // L'URL de la Servlet
public class JsonSalesByProductController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        // Fabrique le tableau de données en exécutant une requête du DAO
        try {
            resultat.put("records", dao.salesByProduct(dateDebut, dateFin));
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(JsonSalesByProductController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
