...
@WebServlet(name = "salesByZone", urlPatterns = {"/salesByZone"}) // L'URL de la Servlet
public class JsonSalesByZoneController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            resultat.put("records", dao.salesByZone(dateDebut, dateFin));
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(JsonSalesByZoneController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
