...
@WebServlet(name = "supprCommande", urlPatterns = {"/supprCommande"}) // L'URL de la Servlet
public class JsonSupprCommandeController extends HttpServlet {
    /**
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(JsonSupprCommandeController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
